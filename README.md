...
The new wrapped events allow for easy organizaton and disposal of BindableEvents and RBXScriptSignal(s) connections. Check out the API [here](https://github.com/rT0mmy/event)
